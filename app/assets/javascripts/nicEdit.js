...
var nicEditor = bkClass.extend({
  ...
  panelInstance : function(e,o) {
    ...
    var panelElm = new bkElement('DIV').setStyle({width : (parseInt(e.getStyle('width')) + parseInt(e.getStyle('padding')) || e.clientWidth)+'px'}).appendBefore(e);
  ...
  var nicEditorInstance = bkClass.extend({
    ...
    construct : function(e,options,nicEditor) {
      ...
      newX = parseInt(e.getStyle('width')) + parseInt(e.getStyle('padding')) || e.clientWidth;
