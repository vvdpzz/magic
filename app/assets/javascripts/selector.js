ajaxCall = function(url, data, callback, errorCallback, options) {
  data = data || {};
  options = options || {};
  var params = {
    url : url,
...
ajaxJsonPost = function(url, data, callback, errorCallback) {
  data = data || '';
  if (typeof(data) != 'string') {
    data = $.param(data);
  } 
  ajaxCall(url, data, callback, errorCallback, {
    dataType: 'json',
    type: 'POST'
  });
}
ajaxJsonGet = function(url, data, callback, errorCallback) {
	ajaxCall(url, data, callback, errorCallback, {
		dataType: 'json',
		type: 'GET'
	});
}
ajaxJson = ajaxJsonPost;
...
Selector = function(options) {
  ...
  ***************************/
  ...
  searchSelector = function(options) {
    ...
    simpleSelector = function(options) {
